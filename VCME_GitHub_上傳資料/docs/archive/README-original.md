...
![VCME System Architecture](../figures/system-architecture.jpg)
...
![VCME AI Pipeline](../figures/ai-pipeline.jpg)
...
- `VCME-signed(2).pdf`（原始 README 引用的檔案，未包含於目前 repository；現有報告請見[新版 README](../../README.md#documents)。）
